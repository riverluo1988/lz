...
select transform(day,room_id,domain,begin_time,end_time,max_viewer,accumulative_viewer_total,execute_times,begin_flower_count,end_flower_count,from_qq,live_permission,live_source_type,live_stream_type,game_id,game_name,play_title,is_live)
using 'python combine2.py'as (day,room_id,domain,begin_time,end_time,max_viewer,accumulative_viewer_total,execute_times,begin_flower_count,end_flower_count,from_qq,live_permission,live_source_type,live_stream_type,game_id,game_name,play_title,is_live)
from(
...
where day='${hiveconf:y_date}' and room_id is not null order by room_id, begin_time)a;
